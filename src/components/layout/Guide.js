    ...
    <div className="guide">
      ...
      <div className="tip">
        ...
        <p>
          ...
          finished mark as "Mark as done"
        </p>
        <img src={tags} className="x2" />
        <p>
          User can add new tag, there are some default tags: priority, normal
          and important. Only user created tags are editable and removable. User
          can view tasks grouped by tag or "show all of them"
        </p>
      </div>
      <div className="tip">
        ...
        <p>
          ...
          the bottom to add new task instantly. At "all task view", using
          quickly add bar means task will have "normal" tag
        </p>
      </div>
      <div className="tip">
      ...
      <div className="tip">
        ...
        <p>
          At kanban view, user can view all tag progress, reorder them within
